package com.octoperf.petstore.utility;
...
public class Utility extends BasePage {
    ...
    public void selectByValueFromDropDown1(By by, String value) {
        Select select = new Select(driver.findElement(by));
        select.selectByValue(value);
    }

    public void selectByValueFromDropDown1(WebElement element, String value) {
    ...
    public String selectByValueFromDropDownByVisibleText(WebElement element, String value) {
        Select select = new Select(element);
        select.selectByVisibleText(value);
        return value;
    }

    public String clickOnWebElementByText(WebElement element,String text){
        element.click();
        return text;
    }
    ...
    public void softAssertTextToVerify(WebElement element,String expected){
        SoftAssert softAssert = new SoftAssert();
        String actualMessage = element.getText();
        softAssert.assertEquals(expected,actualMessage);
        System.out.println(actualMessage);
        softAssert.assertAll();
    }


    public String selectingTopMainMenuTab(String tabName, List<WebElement> elements ){

        String text = null;

        for(WebElement menu:elements)
            if (menu.getText().equalsIgnoreCase(tabName)) {
                text = menu.getText();
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/octoperf/petstore/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/octoperf/petstore/screenshots/" + screenshotName + dateName + ".png";
